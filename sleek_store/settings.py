"""
Django settings for sleek_store project.
...
SECRET_KEY = 'django-insecure-nw9h5y5n6*l2be8^hnax8fju1m8^f1g#_-c3hr=g(tcx0o5f=w'
...
WSGI_APPLICATION = 'sleek_store.wsgi.application'
